...
if ( &t_Co >= 255 || $TERM =~? "256color" )
  hi Normal         term=none cterm=none ctermfg=93 ctermbg=none
  hi Boolean        term=none cterm=none ctermfg=51  ctermbg=none
  hi Character      term=none cterm=none ctermfg=60   ctermbg=none
  hi Comment        term=none cterm=none ctermfg=68  ctermbg=234
  hi Conditional    term=none cterm=none ctermfg=51  ctermbg=none
  hi Constant       term=none cterm=none ctermfg=60   ctermbg=none
  hi Cursor         term=none cterm=none ctermfg=232  ctermbg=234
  hi CursorLine     term=none cterm=none ctermfg=none ctermbg=234
  hi CursorLineNr   term=none cterm=none ctermfg=51  ctermbg=234
  ...
  hi DiffDelete     term=none cterm=none ctermfg=68  ctermbg=237
  ...
  hi Function       term=none cterm=none ctermfg=51  ctermbg=none
  ...
  hi ModeMsg        term=none cterm=none ctermfg=51  ctermbg=none
